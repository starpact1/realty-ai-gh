                ...
                <Container variant="ct25" >
                    <Grid container sx={{}}>
                        <Grid item xs={8} sx={{ display: "flex", textAlign: "left", justifyContent: "start", alignItems: "center" }}>
                            <Typography variant="salesPageHeading"> Agreement Clause </Typography>
                        </Grid>
                    ...
                    <Box sx={{ textAlign: "left", mt: "22px" }}>
                        <Typography variant="fs14fw500" lineHeight="18px" letterSpacing="0.01em" color="#323232" >
                            The clauses are  <Typography component="span" variant="greenBadge"> customer friendly </Typography>
                        </Typography>
                    </Box>

                    <Box sx={{ textAlign: "left",  }}>
                        <Typography variant="fs14fw500" lineHeight="18px" letterSpacing="0.01em" color="#323232" >
                            compared to the other projects in the vicinity.
                        </Typography>
                    </Box>
                </Container>
